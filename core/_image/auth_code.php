 ...
 * 作者 Jerry Shaw <jerry-shaw@live.com>
...
for ($i = 0; $i < 10; ++$i) {
    imagearc($image, mt_rand(0, $width), mt_rand(0, $height), mt_rand(0, $width), mt_rand(0, $height), mt_rand(0, 360), mt_rand(0, 360), $colors[mt_rand(0, $color_index)]);
}

for ($i = 0; $i < 2000; ++$i) {
    imagesetpixel($image, mt_rand(0, $width), mt_rand(0, $height), $colors[mt_rand(0, $color_index)]);
}
