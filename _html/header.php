<?php
/**
 * Common language content 通用语言内容
 */
$lang_keys = [
    'nav_home',
    'nav_project',
...
<head>
    <title></title>
    <link rel="stylesheet" type="text/css" href="_style/header.css">
    <link rel="stylesheet" type="text/css" href="_style/footer.css">
    <link rel="stylesheet" type="text/css" href="_style/core.css">
    <script type="text/javascript" src="core/_script/core.js"></script>
</head>
<body>
